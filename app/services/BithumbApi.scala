  ...
  def tickerAll: Future[TickerAll] = {
    ...
    ws.url(api)
      ...
      .map { response =>
        ...
        TickerAll(status,
          Map(
            "BTC" -> TickerData.from((jValue \ "data" \ "BTC").as[TickerWithoutDate], "BTC", now),
            "ETH" -> TickerData.from((jValue \ "data" \ "ETH").as[TickerWithoutDate], "ETH", now),
            "DASH" -> TickerData.from((jValue \ "data" \ "DASH").as[TickerWithoutDate], "DASH", now),
            "LTC" -> TickerData.from((jValue \ "data" \ "LTC").as[TickerWithoutDate], "LTC", now),
            "ETC" -> TickerData.from((jValue \ "data" \ "ETC").as[TickerWithoutDate], "ETC", now),
            "XRP" -> TickerData.from((jValue \ "data" \ "XRP").as[TickerWithoutDate], "XRP", now),
            "BCH" -> TickerData.from((jValue \ "data" \ "BCH").as[TickerWithoutDate], "BCH", now),
            "XMR" -> TickerData.from((jValue \ "data" \ "XMR").as[TickerWithoutDate], "XMR", now),
            "ZEC" -> TickerData.from((jValue \ "data" \ "ZEC").as[TickerWithoutDate], "ZEC", now),
            "QTUM" -> TickerData.from((jValue \ "data" \ "QTUM").as[TickerWithoutDate], "QTUM", now)))
